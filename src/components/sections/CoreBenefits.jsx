// src/components/sections/CoreBenefits.jsx
      ...
      <div className="relative">
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {CORE_BENEFITS.map((item) => (
            <div
              key={item.no}
              className="group flex h-full flex-col rounded-2xl border border-slate-100 bg-white/90 p-6 shadow-sm transition-all hover:-translate-y-1 hover:border-sky-200 hover:shadow-lg"
            >
              {/* Numara */}
